...
public class RoundTripFlightPage extends Base {
	...
	@CacheLookup
	@FindBy(xpath="//li[contains(.,'Round-Trip')]") WebElement Roundtrip;
	@CacheLookup
	...
	public void searchFlights(String fromCity, String toCity,String departureDate, String ReturnDate) 
		...
		public void searchFlightsForExcelData(String fromCity, String toCity, String ddate)
				...
				WebElement dedate = driver.findElement(By.id("fiv_1_25/10/2021"));
				dedate.click();
				//Thread.sleep(5000);
				
				RetDate.click();
				WebElement Redate = driver.findElement(By.id("frth_0_21/11/2021"));
				Redate.click();
				//Thread.sleep(5000);
