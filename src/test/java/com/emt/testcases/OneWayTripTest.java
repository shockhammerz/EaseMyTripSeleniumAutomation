...
import com.emt.pages.OneWayTripFlightPage;
import com.emt.util.TestUtil;

public class OneWayTripTest extends Base {

	OneWayTripFlightPage flightPage;
	TestUtil utliclass;
	...
	public void setup() {
		intialization();
		flightPage = new OneWayTripFlightPage();
	...
	public void searchFlightsForOneWayTripTest(String fromcity, String tocity, String ddate) 
			throws Exception {
		flightPage.searchFlightsForExcelData(fromcity, tocity, ddate);
		assertEquals("FlightList Lowest Airfare, Flight Tickets, Cheap Air Tickets – EaseMyTrip.com", 
				driver.getTitle());
	}
	...
	public void flightPageTest() throws Exception {
		flightPage.searchFlights(prop.getProperty("fromcity"), prop.getProperty("tocity"),
				prop.getProperty("departuredate"));
		assertEquals("FlightList Lowest Airfare, Flight Tickets, Cheap Air Tickets – EaseMyTrip.com", 
				driver.getTitle());
